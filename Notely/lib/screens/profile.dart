  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          //displays the user profile information as a whole
            ...
            Container(
              ...
              child: Column(
                children: <Widget>[
                  Container(
                    child: Row(
                      //displays the username, follow button, profile pic, and the num of posts, likes, and followers
                      children: <Widget>[
                        Container(
                          child: Column(
                            //displays username, follow button, and the num of posts, likes, and followers
                            children: <Widget>[
                              Container(
