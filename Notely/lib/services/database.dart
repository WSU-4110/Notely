...
class DatabaseService {
  ...
  Future createPost(
      String postTitle, File image, String userId, List<String> tags) async {
    dynamic url;
  ...
  Future createMultiplePicPost(String postTitle, File mainImage, String userId,
      List<File> images, List<String> tags) async {
